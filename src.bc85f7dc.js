...
function $W8bA$export$default(element, includeScale) {
  ...
  if ($wsKO$export$isHTMLElement(element) && includeScale) {
    ...
    if (offsetWidth > 0) {
      scaleX = $FuL6$export$round(rect.width) / offsetWidth || 1;
    }

    if (offsetHeight > 0) {
      scaleY = $FuL6$export$round(rect.height) / offsetHeight || 1;
    }
  }
...
function $M7BJ$var$getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === $XHUo$export$viewport ? $rB0G$export$default($E2lw$export$default(element)) : $wsKO$export$isElement(clippingParent) ? $M7BJ$var$getInnerBoundingClientRect(clippingParent) : $rB0G$export$default($yEje$export$default($sJcE$export$default(element)));
...
function $M7BJ$var$getClippingParents(element) {
  ...
  return clippingParents.filter(function (clippingParent) {
    return $wsKO$export$isElement(clippingParent) && $x3Ja$export$default(clippingParent, clipperElement) && $B1zX$export$default(clippingParent) !== 'body' && (canEscapeClipping ? $S6rb$export$default(clippingParent).position !== 'static' : true);
  });
